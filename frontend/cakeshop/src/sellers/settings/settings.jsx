            ...
            <div class="privacy-box">
              <div class="form-check custom-form-check custom-form-check-2 d-flex align-items-center">
                <input
                  ...
                  name="desktop"
                />
                <label class="form-check-label ms-2" for="dnd">
                  DND
                </label>
              </div>
            </div>
            ...
            <div class="privacy-box">
              <div class="form-check custom-form-check custom-form-check-2 d-flex align-items-center">
                <input
                  ...
                  name="usable"
                />
                <label class="form-check-label ms-2" for="other-2">
                  Other
                </label>
              </div>
            </div>

            <button class="btn theme-bg-color btn-md fw-bold mt-4 text-white" onClick={()=>handleClickDeleteAccount()}>
              Delete My Account
            </button>
          </div>
        </div>
