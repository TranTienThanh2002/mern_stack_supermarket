...
export const BecomeSeller = () => {
  ...
  const handleClickCreateSeller = async (e) => {
    e.preventDefault();
    document.querySelector(".modal-backdrop").classList.add("show");
    document.querySelector(".theme-modal").classList.add("show");
  };
  const handleClose = () => {
    document.querySelector(".modal-backdrop").classList.remove("show");
    document.querySelector(".theme-modal").classList.remove("show");
  };
            ...
            <div class="col-xxl-4 order-lg-2">
              <div class="poster-box">
                <div class="poster-image">
                  <img
                    src="https://themes.pixelstrap.com/fastkart/assets/images/vendor-page/become-saller.svg"
                    class="img-fluid"
                    alt=""
                  />
                </div>
                  ...
                  <div>
                    ...
                    <div class="business-detail">
                      ...
                      <p>
                        ...
                        catalogue. Sell under your own private label or sell an
                        existing brand. Get your documentation & cataloging done
                        with ease from our Professional Services network.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="business-box">
                  <div>
                    ...
                    <div class="business-detail">
                      ...
                      <p>
                        Once listed, your products will be available to millions
                        of users.Get orders and manage your online business via
                        our Seller Panel and Seller Zone Mobile App.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="business-box">
                  <div>
                    ...
                    <div class="business-detail">
                      ...
                      <p>
                        Receive quick and hassle-free payments in your account
                        once your orders are fulfilled. Expand your business
                        with low interest & collateral-free loans.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section class="selling-section section-b-space">
        <div class="container-fluid-lg">
          <div class="vendor-title">
            <h5>Start Selling</h5>
            <p>
              Fastkart marketplace is India's leading platform for selling
              online. Be it a manufacturer, vendor or supplier, simply sell your
              products online on Fastkart and become a top ecommerce player with
              minimum investment. Through a team of experts offering exclusive
              seller workshops, training, seller support and convenient seller
              portal, Fastkart focuses on educating and empowering sellers
              across India. Selling on Fastkart.com is easy and absolutely free.
              All you need is to register, list your catalogue and start selling
              your products.
            </p>
          </div>
          <form>
            <div class="row">
              <div class="col-12">
                {data.store === "" && (
                  <button
                    class="btn btn-md mt-3 theme-bg-color text-white"
                    onClick={(e) => handleClickCreateSeller(e)}
                  >
                    Start Selling
                  </button>
                )}
